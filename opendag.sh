...
echo Downloading demonstration projects...
mkdir -p ~/workspace
cd ~/workspace

git clone https://github.com/tijmenjoppe/IPASS_BattleshipAI
git clone https://github.com/tijmenjoppe/IPASS_CatanAI
...
git clone https://github.com/tijmenjoppe/IPASS_NKepler
git clone https://github.com/tijmenjoppe/IPASS_Rummi
git clone https://github.com/tijmenjoppe/IPASS_Scrabble
git clone https://github.com/tijmenjoppe/IPASS_SudokuMagic
